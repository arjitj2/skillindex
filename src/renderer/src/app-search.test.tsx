...
function createDesktopApi(inventorySnapshot: SkillInventorySnapshot): SkillIndexDesktopApi {
  ...
  return {
    ...
    retryUpdateInstall: vi.fn().mockResolvedValue({ phase: 'disabled' }),
    openManualUpdateDownload: vi.fn().mockResolvedValue(undefined),
    dismissUpdateRecovery: vi.fn().mockResolvedValue({ phase: 'disabled' }),
